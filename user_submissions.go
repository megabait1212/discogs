...
func (s *UserSubmissionsService) Get(username string) (*UserSubmissions, *Response, error) {
	GetAccessToken()

	u := fmt.Sprintf("http://api.discogs.com/users/%s/submissions", username)
